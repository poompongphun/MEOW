<template>
    <div class="grid grid-cols-2 bg-primary rounded-lg drop-shadow-md">
        ...
        <div class="flex flex-col justify-between rounded-lg bg-whtran p-8">
            <div>
                <p class="uppercase font-medium text-3xl mb-3 ">
                    MSI Geforce RTX 3090
                </p>
                <p class="text-lg">
                    Short detail: VGA บลาาา Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor adipisci magni aliquid! Quae iure necessitatibus maiores eveniet velit, perferendis voluptatem quaerat temporibus obcaecati omnis architecto quod consequuntur quis aperiam doloribus?
                </p>
            </div>
            <div>
